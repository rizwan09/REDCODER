...
#bash run_all_retrieved_top_1_ORI_N_RAW_CODE.sh 0,1,2,3
...
path_2_data="/local/rizwan/workspace/projects/RaProLanG/data/plbart/concode/all_retrievd_top_1_ORI_N_RET_CODE/"
...
if [[ "$USE_PLBART" = true ]]; then
    ...
    MODEL_DIR_NAME="plbart-three-langs-all_retrievd_top_1_ORI_N_RET_CODE"
else
    MODEL_DIR_NAME="transformer-all-langs-all_retrievd_top_1_ORI_N_RET_CODE"
fi
