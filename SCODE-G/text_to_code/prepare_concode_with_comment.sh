...
#SAVE_DIR="/local/rizwan/workspace/projects/RaProLanG/data/plbart/concode_graphcodebert_with_comments/${WITH_OR_WITHOUT_REF}_ref_top_${top_k}"
SAVE_DIR="/local/rizwan/workspace/projects/RaProLanG/data/plbart/concode_codebert_with_comments/${WITH_OR_WITHOUT_REF}_ref_top_${top_k}"
mkdir -p $SAVE_DIR
