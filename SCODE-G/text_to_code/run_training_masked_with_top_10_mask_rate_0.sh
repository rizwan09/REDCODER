...
path_2_data="/local/rizwan/workspace/projects/RaProLanG/data/plbart/concode/training_ori_with_maksed_top_10_mask_rate_0/"
...
#    MODEL_DIR_NAME="plbart_ori_with_top_2_masked"
    MODEL_DIR_NAME="plbart-training-masked-with-top-10-mask-rate-0"
else
