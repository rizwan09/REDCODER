...
path_2_data="/local/rizwan/workspace/projects/RaProLanG/data/plbart/concode/top_1_NO_CONCODE_VARS_true_UNION_INTERSECTION"
...
if [[ "$USE_PLBART" = true ]]; then
    ...
    MODEL_DIR_NAME="plbart-three-langs-top_1_NO_CONCODE_VARS_true_UNION_INTERSECTION"
else
    MODEL_DIR_NAME="transformer-all-langs-top_1_NO_CONCODE_VARS_true_UNION_INTERSECTION"
fi
