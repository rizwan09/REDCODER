...
path_2_data="/local/rizwan/workspace/projects/RaProLanG/data/plbart/concode/bm25top_${TOP_K}_${WITH_OR_WITHOUT_REF}"
...
if [[ "$USE_PLBART" = true ]]; then
    ...
    MODEL_DIR_NAME="plbart-bm25-concode-${LANG}-top-${TOP_K}-${WITH_OR_WITHOUT_REF}"
else
