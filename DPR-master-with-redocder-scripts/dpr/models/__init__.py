...
def init_hf_roberta_reader(args, **kwargs):
    if importlib.util.find_spec("transformers") is None:
        raise RuntimeError('Please install transformers lib')
    from .hf_models import get_roberta_reader_components
    return get_roberta_reader_components(args, **kwargs)
...
READER_INITIALIZERS = {
    ...
    'hf_roberta': init_hf_roberta_reader,
}
