...
CHECKPOINT_DIR_PATH="/home/rizwan/DPR_models/biencoder_graphcode_models_csnet_text_code_with_hard_neg/"+lang #+"_new/"
...
command = "CUDA_VISIBLE_DEVICES="+CUDA_VISIBLE_DEVICES \
     +" python -m torch.distributed.launch --nproc_per_node="+str(len(DEVICES)) \
      + ' --master_port=' + str(mport) + " train_dense_encoder_with_hard_neg.py \
     --max_grad_norm 2.0 \
     ...
     --warmup_steps 1237 \
     --batch_size 6 \
     --train_file /local//rizwan/workspace/projects/RaProLang/retrieval/bm25/codexglue-csnet-" + lang +".train_bm25.json   \
     --dev_file  /local//rizwan/workspace/projects/RaProLang/retrieval/bm25/codexglue-csnet-" + lang +".valid_bm25.json \
