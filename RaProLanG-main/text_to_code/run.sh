...
path_2_data="/local/rizwan/workspace/projects/RaProLanG/data/plbart/concode/testing_ori_with_maksed_top_5_retrived_without_testset/"
...
#    MODEL_DIR_NAME="plbart_ori_with_top_2_masked"
    MODEL_DIR_NAME="plbart-training-masked-with-top-5-mask-rate-0.25"
else
    MODEL_DIR_NAME="transformer-training-masked-with-top-5-mask-rate-0.35"
fi
