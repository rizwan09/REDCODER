...
path_2_data="/local/rizwan/workspace/projects/RaProLanG/data/plbart/concode/top_${TOP_K}"; #old
#path_2_data="/local/rizwan/workspace/projects/RaProLanG/data/plbart/concode/ori_with_top_2_masked/"
path_2_data="/local/rizwan/workspace/projects/RaProLanG/data/plbart/concode/training_ori_with_maksed_top_5/"
...
#    MODEL_DIR_NAME="plbart_ori_with_top_2_masked"
    MODEL_DIR_NAME="plbart-training-masked-with-top-1"
else
