...
path_2_data="/local/rizwan/workspace/projects/RaProLanG/data/plbart/concode/top_1_NL_N_UNIQUE"
...
if [[ "$USE_PLBART" = true ]]; then
    ...
    MODEL_DIR_NAME="plbart-three-langs-top_1_NL_N_UNIQUE"
else
    MODEL_DIR_NAME="transformer-all-langs-top_1_NL_N_UNIQUE"
fi
