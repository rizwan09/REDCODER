...
USE_PLBART=${3:-true}
TOP_K=${4:-10}
WITH_OR_WITHOUT_REF=${4:-with} #with or no

task=translation_from_pretrained_bart

path_2_data="/local/rizwan/workspace/projects/RaProLanG/data/plbart/concode_codebert_with_comments/${WITH_OR_WITHOUT_REF}_ref_top_${TOP_K}"
...
#    MODEL_DIR_NAME="plbart_ori_with_top_2_masked"
    MODEL_DIR_NAME="plbart-concode-comments-codebert-${LANG}-top-${TOP_K}-${WITH_OR_WITHOUT_REF}"
fi
